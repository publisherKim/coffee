...
# 커피학개론
## 다음 설명에 적합한 커피에 관한 기원설로 맞는 것은? 4. 칼디의 전설
<pre>
...
## 다음 중 커핑에 이용되는 감각이라고 보기 어려운 것은? 3. 청각
- 시각
- 후각
- 청각
- 미각
...
## 다음 괄호 안에 들어갈 나라는? 4. 러시아
<pre>
한국에서 커피가 들어온 것은 1896년 아관파천 때 () 공사가 커피나무의 열매를 들여오면서 부터이다.
</pre>
- 일본
- 미국
- 중국
...
## 보스턴 차 사건 이후 커피를 마셨으며 최대 소비국으로 알려진 나라는? 3. 미국
- 영국
- 에티오피아
- 미국
- 체코
...
## 커피의 신선도 유지에 대한 설명이다. 틀린 것은? 1. 분쇄된 커피는 맛과 향의 휘발속도가 현저히 느려진다.
- 분쇄된 커피는 맛과 향의 휘발속도가 현저히 느려진다.
- 로스팅 후 약 2주가 지나면 맛과 향이 많이 소멸된다.
- 공기와 접촉에 의해 큰 영향을 받는다.
- 로스팅 후 발생하는 이산화탄소가 공기를 차단하는 역활도 한다.


## 다음 중 커피 재배조건으로 틀린 것은? 1. 서리가 잦은 지역
- 서리가 잦은 지역
- 연 강수량 1,500 ~ 2000mm
- 배수가 좋은 화산성 토양
- 연평균 기온 20도씨
...
## 다음은 커피를 품종 개량하는 이유이다. 틀린 것은? 3. 생두 사이즈를 가능한 작게 하기 위해
- 가뭄과 서리에 강한 품종을 위해
- 병충해에 강한 품종을 위해
...
## 식품이 조리나 가공 과정에서 갈색으로 변하는 것을 일컫는 말은? 1. 갈변 반응
- 갈변 반응
- 색소 반응
- 침출 반응 
- 삼투압 반응
...
## 체(일정 크기의 구멍이 있음)의 통과 여부로 생두의 크기를 분류하는 방법은? 2. 스크린 사이즈
- 사이즈 메시
- 스크린 사이즈
- 오버 사이즈
- 빈 스케일
...
## 커피를 과다하게 마실 경우 빠져나간다고 알려진 영양성분은? 4. 칼슘
- 나트륨
- 비타민B
- 지질
- 칼슘
...
## 커피에 어떤 것의 '첨가 유무'에 따라 분류되는 명칭이 아닌 것은? 1. 스트레이트 커피
- 스트레이트 커피
- 디카페인 커피
- 레귤러 커피
- 향 커피
...
## 다음은 커피나무에 관한 설명이다. 틀린 것은? 3. 열매 수확량을 늘리기 위해 크기를 높게 자라게 한다.
- 열매에는 대부분 두 쪽의 씨가 있다.
- 핵과 외피는 두꺼운 펄프로 싸여 있다.
- 열매 수확량을 늘리기 위해 크기를 높게 자라게 한다.
- 꼭수서니과의 상록수이다.


# 커피기계학
## 다음은 그라인더의 호퍼에 관한 설명이다. 가장 틀린 것은? 1. 물기가 있는 상태에서 사용해도 무방하다.
- 물기가 있는 상태에서 사용해도 무방하다.
- 일반적으로 용량은 2kg을 많이 쓴다.
- 원두의 오일 성분이 묻게 됨으로 청결이 중요하다.
- Cover와 원두 투입 레버로 구성된다.


## 그룹 헤드가 동 재질로 만들어진 이유로 가장 타당한 것은? 1. 온도 유지를 위해
- 온도 유지를 위해
- 도금이 쉬워서
- 디자인이 좋아서
- 내구성을 높이기 위해
...
## 스파웃이 없고 에스프레소 추출 모습을 볼 수 있도록 바스켓의 바닥이 노출된 포터필터는? 4. 버텀 리스
- 백 프레서
- 더블 헤드
- 트리플 레버
- 버텀 리스
...
## 아래 그림속 부품의 알맞은 명칭은? 3. 보일러 압력게이지
<img src="./img/pressGage.jpg" width="150px"></img>
...
## 워터드립 추출방식은 어떤 힘의 작용을 이용한 것인가? 2. 중력
- 원심력
- 중력
- 항력
- 양력 
...
## 하나의 보일러로 온수, 스팀, 추출수 모두를 가열하는 방식은? 1. 일체형 보일러
- 일체형 보일러
- 독립형 보일러
- 분리형 보일러
- 혼합형 보일러
...
## 다음 중 일반적으로 9bar의 압력을 이용하여 커피를 추출하는 방식으로 옮은 것은? 4. 커피머신에 의한 추출
- 핸드르립에 의한 추출
- 사이폰에 의한 추출
- 모카포트에 의한 추출
- 커피머신에 의한 추출
...
## 다음 중 커피 머신의 전원이"OFF"된 원인과 가장 거리가 먼 것은? 2. 수돗물 단수
- 플러그 및 콘센트 이상
- 수돗물 단수
- 전원 스위치 불량
- 메인 배전반 차단기 이상
...
## 다음이 설명하는 커피 머신의 부품으로 옳은 것은? 1. 그룹 개스킷
<pre>
- 커피머신의 소포품이다.
...
## 1947년 스프링 레버에 피스톤을 연결해 압축식 커피 머신을 발명한 사람은? 3. 가찌아
- 훼마
- 파보니
- 가찌아
- 배쩨라
...
# 커피추출원론
## 다음중 좋은 에스프레소를 위한 조건에 해당하지 않는 것은? 2. 고운 거품의 스티밍 기술
- 커피와 물의 적정비율
- 고운 거품의 스티밍 기술
- 추출기구의 선택과 적절한 조작
- 추출시간에 따른 정확한 분쇄
...
## 다음 중 사이폰의 구조와 관계가 없는 것은? 3. 하단포트
- 로드
- 플라스크
- 하단 포트
- 알코올램프 또는 버너
...
## 원두 분쇄 시 고려해야 할 사항이다. 틀린 것은? 1. 분쇄 시 추출방법까지 생각할 필요 없다.
...
## 다음 중 알콜 성분이 들어간 메뉴로 맞는 것은? 2. 아이리시 커피
- 카페라떼
- 아이리시 커피
- 에스프레소 로마노
- 카페 콘판나
...
## 다음 중 스티밍 작업에 유리하며 지방 함량을 2% 이내로 줄인 우유로 맞는 것은? 2. 저지방 우유
- 살균 우유
- 저지방 우유
- 멸균 우유
- 탈지 우유
...
## 다음 중 가장 오래된 추출 기구이며 터키식 커피 추출에 이용되는 것은? 3. 이브릭 또는 체즈베
- 프렌치 프레스
- 클레버
- 이브릭 또는 체즈베
- 커피머신
...
## 커피 추출 방법 중 여과법에 해당하는 것은? 3. 핸드드립
- 모카포트
- 프린체 프레스
- 핸드드립
- 에스프레소 머신
...
## 커피바리스타에게 요구되는 업무라고 보기 어려운 것은? 1. 구매 대행
- 구매 대행
- 좋은 원두 선별요령
- 친절한 고객 서비스
- 재고 관리
...
## 라뗴아트를 할 때 우유를 밀어 넣는 기법을 일컫는 말은? 1. 푸어링
- 푸어링
- 믹싱
- 랜더링
- 페인팅
...
## 커피 머신을 이용한 추출 방법으로 맞는 것은? 3. 가압추출법
- 달임법
- 우려내기법
- 가압추출법
- 여과법
...
## 다음 중 핸드드립 커피의 특징이 아닌 것은? 4. 추출 시간이 신속하다.
- 부드럽고 깔끔한 맛이 특징이다.
- 기구 가격이 비교적 저렴하다.
- 추출 기술이 중요하다.
- 추출 시간이 신속하다.
...
# 매장관리서비스
## 다음은 고객으로부터 주문을 받는 방법이다. 가장 틀린 것은? 3. 메뉴에 사용된 재료, 조리방법까지를 알아야 할 필요는 없다.
- 메뉴를 설명할 때는 명료하게 한다.
...
## 식자재 관리의 최종 목적으로 다음 중 옳은 것은? 4. 원가 절감
- 식자재 가격 결정
- 식자재 품질 향상
- 식자재 수량 파악
- 원가 절감
...
## 다음 중 식품 위생법 상 식품위생교육 대상자가 아닌 것은? 1. 인테리어업자
- 인테리어업자
- 식품운반업자
- 식품보존업자
- 식품가공업자
...
## 고객에게 사용하는 용어 중 주의해서 써야 하는 것은? 3. 모릅니다.
- 어서 오십시오.
- 안녕하십니까?
- 모릅니다.
- 죄송합니다.
...
## 다음은 고객이 필기구를 찾을 때의 행동으로 바르지 않은 것은? 1. 펜 끝을 고객 쪽으로 향하게 거넨다.
- 펜 끝을 고객 쪽으로 향하게 거넨다.
- 두 손으로 받쳐서 건넨다.
- 15도 각도로 건네는 것이 좋다.
- 필기구는 항상 충분히 준비해 둔다.
...
## 다음 중 물리적 살균/소독에 속하지 않는 것은? 3. 알코올 살균
- 자외선 살균
- 방사선 살균
- 알코올 살균
- 열탕 살균
...
## 커피바리스타의 용모에 관한 설명이다. 틀린 것은? 2. 향이 강한 화장품을 사용한다.
- 남자의 경우 면도를 깔끔히 한다.
- 향이 강한 화장품을 사용한다.
- 구강 청결에 주의한다.
- 진한 화장을 하지 않는다.
...
## 다음은 카페를 창업하려 할 때 준비사항으로 가장 맞지 않는 것은? 3. 인테리어 비용은 가능한 많이 지출한다.
- 해당 분야의 전문 지식을 습득해야 한다.
- 카페의 컨셉을 정확히 설정한다.
- 인테리어 비용은 가능한 많이 지출한다.
- 정확한 상권분석을 한다.


## 다음은 커피를 고객에게 제공하는 방법 중 바르지 않은 것은? 1. 티스푼과 손잡이는 고객 왼쪽으로 향해 서비스 한다.
- 티스푼과 손잡이는 고객 왼쪽으로 향해 서비스 한다.
- 고객이 남녀인 경우 여성부터 서비스한다.
- 연장자에게 먼저 서비스한다.
- 커피는 트레이에 들어 운반한다.


## 접객 서비스 중 용모에 관한 설명이다. 바람직하지 않은 것은? 4. 문신은 유행이므로 많이 할수록 좋다. 
- 남성은 뒷머리가 와이셔츠 깃을 넘지 말아야 한다.
- 빗을 가지고 다니면서 자주 거울을 대한다.
- 남성은 옆머리가 귀를 덮어서는 곤란하다.
- 문신은 유행이므로 많이 할수록 좋다.
...
# 커피학개론
## 다음 중 커피 원두의 카페인 성분을 최대한 제거하여 제조한 커피를 이르는 말로 맞는 것은? 1. 디카페인 커피
- 디카페인 커피
- 드립 커피
- 믹스 커피
- 더치 커피
...
## 우리가 마시는 한 잔의 커피가 되기까지의 일반적인 과정으로 옳은 것은? 4. 체리 -> 생두가공 -> 로스팅 -> 그라인딩
- 로스팅 -> 체리 -> 생두가공 -> 그라인딩
- 그라인딩 -> 생두가공 -> 로스팅
- 체리 -> 로스팅 -> 그라인딩 -> 생두가공
- 체리 -> 생두가공 -> 로스팅 -> 그라인딩
...
## 다음 중 커피의 3대 원종에 속하지 않는 것은? 2. 그린 베리
- 로부스타
- 그린베리
- 아라비카
- 리베리카
...
## 커피와 같이 인체의 영양섭취보다는 심리/생리적 욕구를 만족시키기 위한 식품은? 2. 기호식품
- 생필품
- 기호식품
- 건강식품
- 완전식품
...
## 다음은 아라비카 품종의 특징이다. 틀린 것은? 3. 병충해에 강하다.
- 에티오피아가 원산지로 알려져 있다.
- 일반적으로 고지대에서 재배된다.
- 병충해에 강하다.
- 주로 원두커피용으로 이용된다.
...
## 다음 중 로스팅 시 거치는 단계라고 보기 어려운 것은? 1. 액화
- 액화
- 1차 크랙
- 냉각
- 건조
...
## 커피 열매 속에 씨가 둥글고 하나 밖에 들어있지 않는 것을 칭하는 말은? 3. 피베리
- 실버스킨
- 센터 컷
- 피베리
- 뉴 크롭
...
## 다음 중 커피 전체의 향기를 총칭하는 말로 맞는 것은? 3. 부케
- 아로마
- 플레이버
- 부케
- 바디
...
## 아래에서 설명하는 아라비카 품종으로 맞는 것은? 2. 티피카
<pre>
- 아라비카 원종에 가장 가까운 품종으로 알려져 있다.
- 생두는 긴 편이고, 녹병에 취약하다.
- 블루마운틴, 하와이 코나가 대표적인 품종이다.
</pre>
- 버번
...
## 커피메뉴 중 카푸친 수도회 수도사들이 입던 옷의색과 비슷하다는 설에 의해 이름 붙여진 것은? 1. 카푸치노
- 카푸치노
- 카페 콘판나
- 카페 아메리카노
- 카페 라떼
...
## 커피가 생산되는 남위 23.5도에서 북위 23.5도 사이의 지역을 일컫는 말로 맞는 것은? 3. 커피 벨트
- 커피 라인
- 커피 지대
- 커피 벨트
- 그린 존
...
# 커피기계학
## 커피 머신에서 커피가 추출되는 속도가 너무 빠를때 그 원인으로 보기 어려운 것은? 1. 수도 밸브가 잠겼을 때
- 수도 밸브가 잠겼을 때
- 원두 투입량이 적을때
- 분쇄 입자가 클때
- 펌프 압력이 너무 높을때
...
## 다음 중 커피 머신의 작동 방식이 아닌 것은? 2. 반영구식
- 수동식
- 반영구식
- 반자동식
- 전자동식
...
## 물리적/화학적 방법을 통해 물을 깨끗하게 하는 기구로 맞는 것은? 3. 정수기
- 연수기
- 온수기
- 정수기
- 스팀기
...
## 커피바리스타가 커피 머신에 대해 가져야 할 태도이다. 가장 틀린 것은? 4. 유통 방식을 알아야 한다.
- 기본 구조를 알아야 한다.
- 추출 원리를 알아야 한다.
- 관리 방법을 알아야 한다.
- 유통 방식을 알아야 한다.
...
## 다음 중 그라인더 날의 재질이 아닌 것은? 3. 플라스틱 재질
- 스틸 재질
- 세라믹 재질
- 플라스틱 재질
- 티타늄 재질
...
## 그룹 헤드의 개스킷에 관한 설명이다. 틀린 것은? 3. 뜨거운 열의 영향을 전혀 받지 않는다.
...
## 경도성분(칼슘/마그네슘 등)을 제거하여 부드러운 물로 만들어 주는 기구는? 1. 연수기
- 연수기
- 정수기
- 온수기
- 제빙기
...
## 커피 머신 설치 시 급수와 배수에 관한 설명이다. 틀린 것은? 1. 급수 라인에 차단 밸브를 설치하면 안된다.
- 급수 라인에 차단 밸브를 설치하면 안된다.
- 배수 라인은 굴곡이 생기지 않도록 주의한다.
- 급수 라인의 수압은 너무 약하면 안된다.
- 배수 라인은 가능한 너무 길게 하지 않는다.


## 다음 중 커피 머신과 관련이 없는 것은? 4. 플라스크
- 스팀 노즐
- 역류 방지 밸브
- 펌프 모터
- 플라스크
...
## 그라인더의 도저에 담긴 분쇄 원두가 아래로 떨어지도록 조정하는 부품으로 맞는 것은? 3. 도저 레버
- 레귤레이터 노브
- 서포트 포크
- 도저 레버
- 호퍼 게이트
...
## 전자석의 원리를 이용하여 온수의 흐름을 통제하는 부품으로 맞는 것은? 3. 온수 전자밸브
- 온수 워터 펌프
- 온수 게이지
- 온수 전자밸브
- 스팀 완드
...
# 커피추출원론
## 다음 중 가장 오래된 추출 기구이며 커피 추출에 이용되는 것은? 3. 이브릭 또는 체즈베
- 프렌치 프레스
- 클레버
- 이브릭 또는 체즈베
- 커피 머신
...
## 커피 머신으로 추출할 때 일반적인 과정으로 바른 것은? 1. 포타필터 분리 -> 그라인딩 -> 탬핑 -> 추출 -> 넉 박스에 버리기
- 포타필터 분리 -> 그라인딩 -> 탬핑 -> 추출 -> 넉 박스에 버리기
- 템핑 -> 그라인딩 -> 포타필터 분리 -> 추출 -> 넉 박스에 버리기
- 포타필터 분리 -> 추출 -> 탬핑 -> 그라인딩 -> 넉 박스에 버리기
- 그라인딩 -> 추출 -> 템핑 -> 포타필터 분리 -> 넉 박스에 버리기
...
## 커피와 물에 대한 설명이다 틀린 것은? 2. 커피는 유기물이 많은 물이 좋다.
- 커피 추출액의 90% 정도가 물이다.
- 커피는 유기물이 많은 물이 좋다.
- 순수한 물 자체는 중성이다.
- 커피는 염소성분이 없는 물이 좋다.
...
## 우유의 성분 중 스티밍 시 폼이 생성되는 원리와 밀접한 관계가 있는 것은? 1. 지방
- 지방
- 비타민
- 나트륨
- 미네랄
...
## 라떼아트 시 폼 밀크를 부을때 중요한 포인트라고 보기 어려운 것은? 3. 압력
- 높이
- 유속
- 압력
- 유량
...
## 핸드 드립 추출 시 뜸들이기를 하는 이유로 가장 틀린 것은? 1. 추출 온도 상승
- 추출 온도 상승
- 탄산가스 배출
- 향과 맛 성분의 원활한 추출
- 물의 접촉면적 확보
...
## '스팀 피처를 이용해 폼 밀크를 에스프레소에 부으면서 흔들다'는 의미로 맞는 것은? 2. 핸들링
- 쉐이킹
- 핸들링
- 그라인딩
- 휘핑
...
## 다음 중 커피 향기의 강도를 나타내는 용어가 아닌 것은? 4. 우디
- 리치
- 라운디드
- 풀
- 우디
...
## 커피 향기의 강도 중 '향기가 전혀 없을 때'를 나나태는 용어는? 1. 플랫
- 플랫
- 리치
- 스파이시
- 카라멜
...
## 다음은 종업원을 고용할 때 주의사항이다. 틀린 것은? 3. 종업원은 자신의 이익보다 항상 사장의 이익을 먼저 생각하기 마련이다.
- 고용 여부는 충분한 검토기간을 거쳐 결정한다.
- 고용한 종업원은 실무처리 교육을 철저히 시켜야 한다.
- 종업원은 자신의 이익보다 항상 사장의 이익을 먼저 생각하기 마련이다.
- 100% 맘에 드는 종업원은 없다고 생각하는 것이 바람직하다.
...
## 매장의 화재 예방에 관한 내용이다. 맞지 않는 것은? 4. 소화기 있는 위치는 수시로 변경한다.
- 인화물질 방치 여부를 사전에 점검한다.
- 방화문이 있는 경우 작동 여부를 수시로 점검한다.
- 소화기구 적재를 수시로 확인한다.
- 소화기 있는 위치는 수시로 변경한다.
...
## 아로마 밸브를 포장지에 부착하는 포장 기법은? 3. 밸프 포장
- 원웨이 포장
- 진공 포장
- 밸브 포장
- 질소 포장
...
## 다음 중 식자재 관리범위에 속하지 않는 것은? 1. 서비스
- 서비스
- 구매
- 검수
- 저장
...
## 다음은 고객 분실물을 습득 했을 때의 행동 수칙이다. 틀린 것은? 3. 일정 기간이 지나도 주인이 없으면 임의로 처분한다.
- 귀중품인 경우 경찰서 등에 신고한다.
- 분실물은 관리 대장에 기록하는 것이 좋다.
- 일정 기간이 지나도 주인이 없으면 임의로 처분한다.
- 분실물 서비스 품질이 업장의 이미지를 높일 수 있다.


## 식음료 부분 종사원이 갖춰야 할 일반적 요건으로 맞지 않는 것은? 3. 호전성
- 봉사성
- 청결성
- 호전성
- 정직성
...
## 고객의 불평처리에 관한 내용이다. 틀린 것은? 2. 서비스만 완벽하면 불평이 생길 수 없다.
...
## 다음은 환송 서비스에 관한 설며잉다. 틀린 것은? 2. 영접 서비스에 비해 중요성은 떨어진다.
- 출구 쪽 방향으로 정중히 안내한다.
- 영접 서비스에 비해 중요성은 떨어진다.
- 테이블 주위에 분실물이 없는지 확인한다.
- 거동 불편고객은 엘리베이터까지 정중히 안내한다.


## 다음 중 커피 매장 위생관리의 범위가 아닌 것은? 4. 정신위생
- 개인위생
- 주방위생
- 식품위생
- 정신위생
...
## 다음 중 총독 부인과 스페인 연대장의 로맨틱한 상황에서 커피가 전파되었던 나라는? 2. 브라질
- 독일
- 브라질
- 프랑스
- 이탈리아
...
## 우리나라에 1회용 인스턴트 커피가 등장한 시기로 맞는 것은? 4. 6 25 전쟁시 미군에 의해
- 아관파천때 러시아 공관에 의해
- 네델란드에서 돌아온 헤이크 특사에 의해
- 모스크바 3상 회의 때 유엔에 의해
- 6 25 전쟁시 미군에 의해


## 고지대에서 재배된 생두의 특성에 대한 설명이다. 틀린 것은? 1. 고지대 일수록 신맛이 좋지 않다.
- 고지대 일수록 신맛이 좋지 않다.
- 고지대 일수록 밀도가 높다.
- 고지대 일수록 단단하다.
- 고지대 일수록 향과 플레이버가 풍부하다.
...
## 우리가 사용하는 SCAA 로스팅 분류에서 "SCAA"가 뜻하는 단체는? 3. 미국스페셜티커피협회
- 유럽스페셜티커피협회
- 일본스페셜티커피협회
- 미국스페셜티커피협회
- 국제커피테이스팅협회
...
## 로스팅 8단계 분류법 중 가장 강한 로스팅 단계로 맞는 것은? 1. 이탈리안
- 이탈리안
- 풀 시티
- 시나몬
- 라이트
...
## 다음은 커피나무에 관한 설명이다. 틀린 것은? 4. 열매 수확량을 늘리기 위해 크기를 높게 자라게 한다.
- 꼭두시니과의 상록수이다.
- 핵과 외피는 두꺼운 펄프로 싸여 있다.
- 열매에는 대부분 두 쪽의 씨가 있다.
- 열매 수확량을 늘리기 위해 크기를 높게 자라게 한다.
...
## 다음 중 생두 가공방식에 속하지 않는 것은? 3. 스프리트 법
- 건식법
- 습식법
- 스프리트법
- 반건식법
...
## 다음 중 독립형 보일러의 단점이 아닌 것은? 2. 크기가 초대형인 것이 대부분이다.
- 비교적 전기 사용량이 많다.
- 크기가 초대형인 것이 대부분이다.
- 겨울철 동파에 취약한 편이다.
- 상대적으로 유지보수가 어렵다.
...
## 그룹 헤드가 동으로 만들어진 이유로 가장 타당한 것은? 4. 온도 유지를 위해
- 내구성을 높이기 위해
- 도금이 쉬워서
- 디자인이 좋아서
- 온도 유지를 위해
...
## 커피 머신 보일러 안에서 물을 데우는 역활을 하는 부품으로 맞는 것은? 2. 히터
- 수위 감지봉
- 히터
- 에어 밸브
- 지글러
...
## 다음 중 일반적으로 9bar의 압력을 이용하여 커피를 추출하는 방식으로 옳은 것은? 2. 커피머신에 의한 추출
- 핸드드립에 의한 추출
- 커피머신에 의한 추출
- 모카포트에 의한 추출
- 사이폰에의한 추출
...
## 커피와 같이 인체의 영양섭취보다는 심리/생리적 욕구를 만족시키이 위한 식품은? 2. 기호식품
- 생필품
- 기호식품
- 건강식품
- 완전식품
...
## 워터드립 추출 방식은 어떤 힘의 작용을 이용한 것인가? 2. 중력
- 원심력
- 중력
- 항력 
- 양력
...
## 커피 머신에서 떨어지는 물을 받아 배수관으로 흘려주는 받침대의 명칭은? 3. 드립 트레이
- 급수 어셈블러
- 에어 핀
- 드립 트레이
- 바이메탈
...
# 커피추출원론
## 커피가루에 9bar의 압력으로 뜨거운 물을 가하여 짧은 시간 동안 추출한 커피로 맞는 것은? 2. 에스프레소
- 마끼아또
- 에스프레소
- 아메리카노
- 카푸치노
...
## 2배라는 의미의 이탈리아어로, 2잔 분량의 에스프레소를 한 잔에 담은 커피로 맞는 것은? 4. 도피오
- 콘 판나
- 카페 로열
- 카페 갈루아
- 도피오
...
## 우유에 수증기를 불어넣어 거품을 만드는 과정을 일컫는 것은? 1. 스티밍
- 스티밍
- 태핑
- 도징
- 팩킹
...
## 라떼아트 시 전용 송공 따위의 날카로운 도구를 이용하는 기법을 일컫는 말은? 4. 에칭
- 팩킹
- 드릴링
- 포인팅
- 에칭
...
## 한국커피바리스타협회의 커피바리스타 2급 실기에서 요구하는 에스프레소 추출량의 범위는? 2. 20 ~30ml
- 10 ~ 20ml
- 20 ~ 30ml
- 30 ~ 40ml
- 40 ~ 50ml
...
## 커피와 물에 대한 설명이다. 틀린 것은? 3. 커피는 유기물이 많은 물이 좋다.
- 커피 추출액의 99% 정도가 물이다.
- 순수한 물 자체는 중성이다.
- 커피는 유기물이 많은 물이 좋다.
- 커피는 염소성분이 없는 물이 좋다.
...
- 주둥이를 통상 학구라고 한다.
- 배출구는  S자형보다 직선형이 좋다.
- 배출구가 가늘수록 물의 힘은 약해진다.
- 사용 후 뒤집어 보관하는 것이 좋다.


## 이탈리아어로 '길다'는 뜻으로 에스프레소를 시간상 길게 추출한 커피를 가리키는 것은? 2. 룽고
- 도피오
- 룽고
- 리스트레또
- 마끼아또
...
## 다음 중 아래 박스 안에 있는 기구들을 추출하는 방법으로 맞는 것은? 3. 핸드드립
<pre>
포트, 드립퍼, 페이퍼 필터, 융 필터
</pre>
- 더치 커피
...
## 다음 중 커피의 3대 원종에 속하지 않는 것은? 3. 그린베리
- 로부스타
- 아라비카
- 그린베리
- 리베리카
...
## 생두를 로스팅할 떄 가장 많이 감소되는 성분은? 3. 수분
- 카페인
- 탄수화물
- 수분
- 지질
...
# 매장관리서비스
## 고객과의 전화 응대에 관한 설명이다. 틀린 것은? 1. 전화를 놓을 때는 고객이 끊기 전에 미리 끊는다.
- 전화를 놓을 때는 고객이 끊기 전에 미리 끊는다.
- 수화기를 들면 업장명, 이름을 말한다.
- 대화를 할 때는 분명하고 정중하게 한다.
- 전화 받기 전 메모지, 볼펜 등을 항상 준비해 놓는다.


## 다음은 식자재 관리의 원칙에 관한 설명이다. 틀린 것은? 3. 재고 물량은 많을수록 유리하다.
- 불필요한 식자재 구입을 차단한다.
- 저장 관리에 신경을 많이 쓴다.
- 재고 물량은 많을수록 유리하다.
- '식자재는 곧 현금이다'라는 인식을 갖는다.


## 다음은 고객이 떠난 후 테이블 정리 정돈에 관한 사항이다. 가장 틀린 것은? 2. 고객이 자리에서 일어나자마자 정리를 시작한다.
- 정리는 위생적이고 신속하게 한다.
- 고객이 자리에서 일어나자마자 정리를 시작한다.
- 사용된 기물은 종류별로 세척 공간으로 운반한다.
- 정리할 때는 옆 테이블 고객에게 방해가 되지 않도록 한다.


## 다음 중 커피 원두의 카페인 성분을 최대한 제거하여 제조한 커피를 이르는 말로 맞는 것은? 4. 디카페인 커피
- 더치 커피
- 드립 커피
- 믹스 커피
- 디카페인 커피
...
## 접객 서비스 중 용모에 관한 설명이다. 바람직하지 않은 것은? 3. 문신은 유행이므로 많이 할수록 좋다.
- 남성은 뒷머리가 와이셔츠 깃을 넘지 말아야 한다.
- 빗을 가지고 다니면서 자주 거울을 대한다.
- 문신은 유행이므로 많이 할수록 좋다.
- 남성은 옆머리가 귀를 덮어서는 곤란하다.
...
## 다음은 커피바리스타가 고객에게 보이는 태도로서 올바르지 않는 것은? 1. 고객을 교육시켜 알리려는 태도가 중요하다.
- 고객을 교육시켜 알리려는 태도가 중요하다.
- 고객의 입장에서 생각해 본다.
- 고객과의 시선은 안정적으로 유지한다.
- 고객의 말을 경청한다.


## 다음은 종업우너을 고용할 때 주의사항이다. 틀린 것은? 3. 종업원은 자신의 이익보다 항상 사장의 이익을 먼저 생각하기 마련이다.
- 고용 여부는 충분한 검토기간을 거쳐 결정한다.
- 고용한 종업원은 실무처리 교육을 철저히 시켜야 한다.
- 종업원은 자신의 이익보다 항상 사장의 이익을 먼저 생각하기 마련이다.
- 100% 맘에 드는 종업원은 없다고 생각하는 것이 바람직하다.
...
## 인기는 자지만 수익성이 높은 메뉴가 있을 경우 대처방안으로 틀린 것은? 3. 재빠르게 다른 메뉴로 교체한다.
- 가격을 조금 낮춘다.
- 적극적인 추천판매를 한다.
- 재빠르게 다른 메뉴로 교체한다.
- 메뉴판 최상의 위치에 배치시킨다.
...
## 다음은 고객이 필기구를 찾을 때의 행동으로 바르지 않은 것은? 3. 펜 끝을 고객 쪽으로 향하게 건넨다.
- 15도 각도로 건네는 것이 좋다.
- 두 손으로 받쳐서 건넨다.
- 펜 끝을 고객 쪽으로 향하게 건넨다. 
- 필기구는 항상 충분히 준비해 둔다.
...
# 커피학개론
## 다음 중 원두커피 보관법으로 바르지 않은 것은? 3. 냉동 보관하는 것이 좋다.
- 직사광선을 피하는 것이 좋다.
- 밀봉하여 보관하는 것이 좋다.
- 냉동 보관하는 것이 좋다.
...
## 1878년경 묘목이 들어오면서 동양으로 커피를 처음 들여왔다고 알려진 국가는? 1. 일본
- 일본
- 태국
- 중국
- 몽골
...
## 현재 커피의 원산지라고 가장 잘 알려져 있는 나라로 맞는 것은? 4. 에티오피아
- 미국터키
- 브라질
- 터키
- 에티오피아
...
## 다음 중 커피 원두의 카페인 성분을 최대한 제거하여 제조한 커피를 이르는 말로 맞는 것은? 2. 디카페인 커피
- 드립 커피
- 디카페인 커피
- 믹스 커피
- 더치 커피
...
## 생두 가공 방식 중 습식법에 대한 설명으로 틀린 것은? 2. 생산 단가가 상대적으로 낮다.
- 품질이 우수하고 균일하다.
- 생산 단가가 상대적으로 낮다. 
- 대부분 아라비카 생산국이 이용한다.
- 환경오염 문제가 생길 수 있다.
...
## 커피의 유럽 전파에 관한 설명이다. 틀린 것은? 4. 유럽 전파 당시 아랍인에 의해 커피 종자도 자유롭게 거래되었다.
...
## 커피체리 안에 생두를 감싸고 있는 딱딱한 껍질을 무엇이라 하는가? 4. 파치먼트
- 실버스킨
- 센터 컷
- 피베리
- 파치먼트
...
## 커피의 신선도 유지에 대한 설명이다. 틀린 것은? 1. 분쇄된 커피는 맛과 향의 휘발속도가 현저히 느리다.
- 분쇄된 커피는 맛과 향의 휘발속도가 현저히 느리다.
- 로스팅 후 약2주가 지나면 맛과 향이 많이 소멸한다.
- 공기와 접촉에 의해 큰 영향을 받는다.
- 로스팅 후 발생하는 이산화탄소가 공기를 차단하는 역활도 한다.


## 다음 중 수확한지 1년 미만 정도의 생두를 흔히 일컫는 말은? 3. 뉴 크롭
- 패스트 크롭
- 올드 크롭
- 뉴 크롭
- 세미 패스트 크롭
...
## 커피를 삼킨 후 혀 뒤끝 부분에서 느끼는 후미를 표현한 것은 SCAA기준? 2. Aftertaste
- Flavor
- Aftertaste
- Acidity
- Body
...
## 다음 중 로스팅 기기 방식에 속하지 않는 것은? 2. 피스톤식
- 직화식
- 피스톤식
- 열풍식
- 반열풍식
...
## 다음은 에스프레소 추출 속도에 대한 설며이다. 틀린 것은? 3. 펌프 압력이 낮으면 추출이 빨라진다.
- 원두가 신선할수록 추출이 느려진다.
- 도징량이 적으면 추출이 빨라진다.
- 펌프 압력이 낮으면 추출이 빨라진다.
- 분쇄 굵기가 가늘면 추출이 느려진다.
...
## 커피 추출기구 중 사이폰 방식의 또다른 이름으로 맞는 것은? 1. 버큠포트
- 버큠포트
- 램프포트
- 프레셔포트
- 피스톤포트
...
## 다음 중 커피 머신의 그룹 헤드와 관련이 없는 것은? 1. 호퍼 게이트
- 호퍼 게이트
- 샤워 스크린
- 샤워 홀더
- 그룹 개스킷
...
## 커피 머신 보일러 내부의 공기를 빼주는 부품으로 맞는 것은? 3. 에어 밸브
- 스팀 팁
- 콘덴서
- 에어 밸브 
- 솔레노이드 밸브
...
## 다음 중 커피 머신의 작동 방식이 아닌 것은? 4. 반영구식
- 전자동식
- 수동식
- 반자동식
- 반영구식
...
## 수동 그라인더에는 존재하고 자동 그라인더에 없는 부품은? 2. 도저 레버
- 호퍼
- 도저 레버
- 호퍼 게이트
- 입자 조절 레버
...
## 추출 기구의 역사를 시간대별로 맞게 표시한 것은? 3. 이브릭 -> 드립 방식 -> 베큠포트 -> 커피머신
- 베큠 포트 -> 이브릭 -> 드립 방식 -> 커피 머신
- 드립 방식 -> 이브릭 -> 베큠 포트 -> 커피 머신
- 이브릭 -> 드립 방식 -> 베큠 포트 -> 커피 머신
- 이브릭 -> 베큠 포트 -> 드립 방식 -> 커피 머신
...
## 다음 커피 머신 부품 중 공급되는 수압이 일정 수치 이상으로 높아지면 작동되는 장치로 맞는 것은? 1. 과수압 방지밸브
- 과수압 방지밸브
- 스팀 밸브
- 펌프 모터
- 온수 전자밸브
...
## 최초로 증기압을 이용한 커피 머신을 발명한 사람은? 3. 배째라
- 가찌아
- 파보니
- 배째라
- 유라
...
# 커피추출원론
## 다음 중 커피 향미에 대한 관능평가와 가장 관련이 없는 감각은? 3. 촉각
- 미각
- 후각
- 시각
- 촉각
...
## 원두 분쇄 시 고려해야 할 사항이다. 틀린 것은? 3. 분쇄 시 추출방법까지 생각할 필요 없다.
- 커피의 물의 접촉시간을 고려해야 한다.
- 추출 직전에 분쇄하는 것이 좋다.
- 분쇄 시 추출방법까지 생각할 필요 없다.
- 분쇄 시 미분 억제를 고려해야 한다.


## 라떼아트를 할 때 우유를 밀어 넣는 기법을 일컫는 말은? 4. 푸어링
- 렌더링 
- 믹싱
- 페인팅 
- 푸어링
...
## 다음 중 우유 스티밍에 관한 내용이다. 틀린 것은? 1. 스티밍 시 스팀 노즐을 전후좌우로 움직여 주는 것이 좋다.
- 스티밍 시 스팀 노즐을 전후좌우로 움직여 주는 것이 좋다.
- 우유는 차가운 것이 유리하다.
- 스티밍 온도가 너무 높아지면 좋은 결과를 얻을 수 없다.
- 스티밍 전에 스팀 노즐의 잔여 수분을 제거해 주는 것이 좋다.
...
## 에스프레소를 추출하기 위해 물이 공급되고 포타필터를 장착하는 곳으로 맞는 것은? 4. 그룹헤드
- 플로메터
- 보일러
- 솔레노이드 밸브
- 그룹헤드
...
## 다음 중 에스프레소 성분이 과소 추출되는 경우가 아닌 것은? 3. 추출시간이 너무 길다.
- 분쇄 입자가 너무 굵다.
- 물의 온도가 낮다.
- 추출시간이 너무 길다.
- 커피가 적정량보다 적게 사용됐다.
...
## 다음 메뉴 중 우유가 들어가지 않는 것은? 1. 카페 콘판나
- 카페 콘판나
- 카푸치노
- 카페 라떼
- 라떼 마끼아또
...
## 다음 중 좋은 에스프레소를 위한 조건에 해당하지 않는 것은? 2. 고운 거품의 스티밍 기술
- 커피와 물의 적정비율
- 고운 거품의 스티밍 기술
- 추출기구의 선택과 적절한 조작
- 추출시간에 따른 정확한 분쇄
...
## 다음은 스티밍 과정에 대한 설명이다. 틀린 것은? 3. 스팀밸브를 먼저 작동시킨 후에 스팀노즐을 우유에 담근다.
- 스티밍 전에 스팀 노즐에 있는 물을 빼준다.
- 부드러운 거품을 알맞게 만들어야 한다.
- 스팀밸브를 먼저 작동시킨 후에 스팀노즐을 우유에 담근다.
- 작업이 마무리되면 스팀노즐을 청소해야 한다.


# 매장관리서비스
## 고객의 분실물 신고 접수 시 기록하는 사항이 아닌 것은? 3. 분실자 성별
- 분실 장소
- 분실 일시
- 분실자 성별
- 보관 담당자
...
## 고객에게 물을 서비스 할 때 행동으로 옳은 것은? 1. 잔을 반드시 손으로 잡고 물을 따른다.
- 잔을 반드시 손으로 잡고 물을 따른다.
- 테이블에 물방울이 떨어지지 않도록 한다.
- 워터 피처를 사용하는 것이 좋다.
- 잔의 8부 정도를 따르는 것이 좋다.


## 다음 중 주방에 발생하는 사고 원인으로 보기 어려운 것은? 3. 식재료 보존 실패
- 시설 및 장비 관리 소홀
- 전기와 가스 사용 부주의
- 식재료 보존 실패
- 작업자들의 피로감
...
## 커피 매장 직원관리에 대한 설명이다. 틀린 것은? 2. 직원 수를 가급적 늘린다.
- 가족경영 형태도 고려할 만하다.
- 직원 수를 가급적 늘린다.
- 인간적 유대관계를 형성한다.
- 일정 권한을 주고 임하게 한다.
...
## 다음은 selling Up(판매 기술)에 관한 내용이다. 틀린 것은? 4. 메뉴 추천은 피상적으로 하는 것이 좋다.
...
## 먼저 저장된 순서에 따라 재료를 사용하는 저장관리 방법은? 1. 선입 선출법
- 선입 선출법
- 후입 선출법
- 우선 선택법
- 저장위치 표시법
...
## 매장의 화재 예방에 관한 내용이다. 맞지 않는 것은? 1. 소화기 있는 위치는 수시로 변경한다.
- 소화기 있는 위치는 수시로 변경한다.
- 방화문이 있는 경우 작동 여부를 수시로 점검한다.
- 인화물질 방치 여부를 사전에 점검한다.
- 소화기구 적재를 수시로 확인한다.
...
## 매장에서 유니폼을 입는 경우에 관한 설명이다. 틀린 것은? 2. 와이셔츠 옷자락이 바지 밖으로 나오게 입는다.
- 깨끗하고 정해진 것을 착용한다.
- 와이셔츠 옷자락이 바지 밖으로 나오게 입는다.
- 명찰이 있다면 정해진 위치에 착용한다.
- 포켓에 불필요한 것들을 넣지 않는다.
...
## 다음 중 로스팅 시 거치는 단계라고 보기 어려운 것은? 2. 액화
- 건조
- 액화
- 냉각
- 1차 크랙
...
## 커피가 우리 인체에 미치는 일반적인 영향이다. 틀린 것은? 4. 피로감 증가
- 항상화 효과
- 이뇨 작용
- 각성 효과
- 피로감 증가
...
## "Coffee"의 어원 중 에티오피아의 지역 이름과 연관되어 있는 것은? 4. 카파
- 카와
- 카페
- 카베
- 카파
...
## 다음 중 커피의 재배조건으로 틀린 것은? 3. 서리가 잦은 지역
- 배수가 좋은 화산성 토양
- 연 강수량 1,500 ~ 2000 mm
- 서리가 잦은 지역
- 연평균 기온 22도씨
...
## 브라질 로부스타의 95% 이상을 차지한다고 알려진 품종은? 1. 코닐론
- 코닐론
- 카투아이
- 문도노보
- 마라고지페
...
## 사람의 손으로 커피를 수확하는 방법으로만 연결된 것은? 2. c-d
<pre>
a. 머천다이징
b. 핸드 메이드
c. 스트립핑
...
## 커피가 생산되는 남위 23.5도에서 북위 23.5도 사이의 지역을 일컫는 말로 맞는 것은? 4. 커피 벨트
- 커피 라인
- 그린 존
- 커피 지대
- 커피 벨트
...
## 커피메뉴 중 카푸친 수도회 수도사들이 입던 옷의 색과 비슷하다는 설에 의해 붙여진 것으로 맞는 것은? 3. 카푸치노
- 카페 콘판나
- 카페 라떼
- 카푸치노
- 카페 아메리카노
...
## 다음 중 커피의 3대 원종에 속하지 않는 것은? 3. 그린 베리
- 로부스타
- 아라비카
- 그린베리
- 리베리카
...
## 다음 중 커핑에 이용되는 감각이라고 보기 어려운 것은? 1. 청각
- 청각
- 시각
- 후각
- 미각
...
## 다음 중 건식법에 대한 설명이 아닌 것은? 3. 펄프를 제거 후 건조시킨다.
- 햇빛이 좋은 지역에서 주로 이용한다.
- 로부스타 생산국에서 주로 이용한다.
- 펄프를 제거 후 건조시킨다.
- 생산 단가가 상대적으로 저렴하다.
...
# 커피기계학
## 스파웃이 없고 에스프레소 추출 모습을 볼 수 있도록 바스켓의 바닥이 노출된 포타필터는? 2. 버텀 리스
- 백 프레셔
- 버텀 리스
- 더블 헤드
- 트리플 레버
...
## 다음 중 포터필터와 전혀 무관한 부품은? 1. 수위 게이지
- 수위 게이지
- 홀더 스프링
- 필터 바스켓
- 필터홀더
...
## 그룹 헤드가 동 재질로 만들어진 이유로 가장 타당한 것은? 4. 온도 유지를 위해
- 내구성을 높이기 위해
- 도금이 쉬워서
- 디자인이 좋아서
- 온도 유지를 위해
...
## 다음은 그라인더의 호퍼에 관한 설명이다. 가장 틀린 것은? 2. 물기가 있는 상태에서 사용해도 무방하다.
- Cover와 원두 투입 레버로 구성된다.
- 물기가 있는 상태에서 사용해도 무방하다.
- 일반적으로 용량은 2kg을 많이 쓴다.
- 원두의 오일 성분이 묻게 됨으로 청결이 중요하다.

## 다음 중 샤워 홀더를 통과한 물을 미세한 망을 통해 분산시켜 주는 부품으로 맞는 것은? 2. 샤워 스크린
- 로터피 펌프
- 샤워 스크린
- 그룹헤드
- 스팀 밸브
...
## 수동 그라인더에는 존재하고 자동 그라인더에는 없는 부품은? 1. 도저 레버
- 도저 레버
- 호퍼 게이트
- 호퍼
- 입자 조절 레버
...
## 다음은 그라인더에 관한 설명이다. 틀린 것은? 4. 그라인더 분쇄도 조정까지를 바리스타가 습득할 필요는 없다.
- 에스프레소 결과물에 지대한 영향을 미친다.
- 에스프레소 품질에서 흔히 그라인더의 비중을 간과하는 경우가 많다.
- 그라인더는 제조사마다 조금씩 운용의 차이가 있다.
- 그라인더 분쇄도 조정까지를 바리스타가 습득할 필요는 없다.
...
## 그라인더 날 중 납작하고 평평한 모양의 날로서 가장 보편적으로 사용되는 것은? 2. 플랫 버
- 코니컬 버
- 플랫 버
- 레이먼드 버
- 커맨트 버
...
## 커피 머신에서 커피가 추출되는 속도가 너무 빠를 때 그 원인으로 보기 어려운 것은? 3. 수도 밸브가 잠겼을 때
- 분쇄 입자가 클 때
- 원두 투입량이 적을 때
- 수도 밸브가 잠겼을 때
- 펌프 압력이 너무 높을 때
...
## 커피 머신 중 우유를 데울 때나 거품을 낼 때 사용하는 것으로서 구멍이 2~5개로 이루어진 것은? 4. 스팀 노즐
- 스파웃
- 포타필터
- 스팀 밸브
- 스팀 노즐
...
# 커피추출원론
## 다음 중 커피 등의 음료 표면에 여러 가지 무늬나 그림을 만들어 내는 기술로 맞는 것은? 2. 라떼 아트
- 페인팅
- 라떼아트
- 드로잉
- 밀크 디자인
...
## 용량이 약 75ml로 일반 컵의 반 정도이며 에스프레소를 마시는 전용잔으로 맞지 않는 것은? 1. 데미타세
- 데미타세
- 머그 컵
- 텀블러
- 고블렛
...
## 다음 중 좋은 에스프레소를 위한 조건에 해당하지 않는 것은? 4. 고운 거품의 스티밍 기술
- 커피와 물의 적정비율
- 추출시간에 따른 정확한 분쇄
- 추출기구의 선택과 적절한 조작
- 고운 거품의 스티밍 기술
...
## 다음 중 사이폰의 구조와 관계가 없는 것은? 1. 하단포트
- 하단 포트
- 플라스크
- 로드
- 알코올 램프 또는 버너
...
## 여러 가지 기구 및 기계를 이용하여 커피 성분을 뽑아내는 과정을 일컫는 말로 맞는 것은? 2. 추출
- 가공
- 추출
- 혼합
- 분쇄
...
## 다음 중 가장 오래된 추출 기구이며 터키식 커피 추출에 이용되는 것은? 4. 이브릭 또는 체즈베
- 프렌치 프레스
- 클레버
- 커피 머신
- 이브릭 또는 체즈베
...
## 다음 중 커피 향기의 강도를 나타내는 용어가 아닌 것은? 2. 우디
- 리치
- 우디
- 풀
- 라운디드
...
## 에스프레소에 휘핑크림을 얹은 메뉴로서 '타차 도로'라고도 불리는 것은? 3. 카페 콘판나
- 카페 아메리카노
- 바닐라 라떼
- 카페 콘판나
- 카페오레
...
## (사)한국커피바리스타협회 커피바리스타 2급 실기 에서 요구하는 '카푸치노' 거품의 양은? 2. 1.5cm이상
- 1cm 이상
- 1.5cm 이상
- 2cm이상
- 2.5cm 이상
...
## 다음 중 분쇄도를 가장 가늘게 하여 추출해야 하는 것은? 4. 에스프레소 추출
- 핸드드립 추출
- 사이폰 추출
- 프렌치 프레스 추출
- 에스프레소 추출
...
## 원두로부터 얼마나 많은 성분을 추출했는지 표현하는 수치는? 4. 추출 수율
- 추출 전도율
- 추출 굴절률
- 추출 용절률
- 추출 수율
...
## 식음료 부분 종사원이 갖춰야 할 일반적 요건으로 맞지 않는 것은? 1. 호전성
- 호전성
- 청결성
- 봉사성
- 정직성
...
## 다음 중 식품위생법 상 식품위생교육 대상자가 아닌 것은? 2. 인테리어업자
- 식품운반업자
- 인테리어업자
- 식품보존업자
- 식품가공업자
...
## 다음은 환송 서비스에 관한 설명이다. 틀린 것은? 1. 영접 서비스에 비해 중요성은 떨어진다.
- 영접 서비스에 비해 중요성은 떨어진다.
- 출구 쪽 방향으로 정중히 안내한다.
- 테이블 주위에 분실물이 없는지 확인한다.
- 거동 불편고객은 엘리베이터까지 정중히 안내한다.
...
## 식품 위생관리의 궁극적인 목적으로 맞는 것은? 1. 질병예방
- 질병예방
- 소비자 만족
- 매출 증대
- 상권 분석
...
## 식품 보존 방법 중 화학처리에 의한 방법이 아닌 것은? 3. 저온 살균법
- 염장법
- 당장법
- 저온 살균법
- 초절임법
...
## 메뉴의 가격을 결절할 때 고려해야 할 사항이다. 틀린 것은? 4. 재료 원가만 고려하면 된다.
- 목표 고객의 경제적 여건을 고려한다.
- 주변 경쟁 상황을 검토한다.
- 목표 매출액을 고려한다.
- 재료 원가만 고려하면 된다.
...
## 다음은 고객 안내요령이다. 틀린 것은? 4. 서로 모르는 고객끼리도 합석시킨다.
- 예약 고객일 경우 준비된 테이블로 안내한다.
- 착석이 완료되면 메뉴판을 제공한다.
- 연로한 고객은 되도록 입구 가까운 곳으로 안내한다.
- 서로 모르는 고객끼리도 합석시킨다.


## 다음 중 메뉴판 구성에 대한 설명으로 틀린 것은? 3. 전문 용어와 어려운 단어를 많이 쓴다.
- 메뉴판은 고객과 커뮤니케이션 기능이 있다.
- 구성이 간단명료하고 정확하게 기재해야 한다.
- 전문 용어와 어려운 단어를 많이 쓴다.
- 수익성이 좋은 아이템을 시선이 집중된 곳에 배열한다.
...
# 커피학개론
## 다음 중 생두를 볶아서 우리가 마시는 원두로 만드는 단계를 일컫는 말로 옳은 것은? 2. 로스팅 단계
- 건조 단계
- 로스팅 단계
- 분쇄 단계
- 추출 단계
...
## 다음은 커피의 기원설에 관한 이야기이다. 밑줄친 부분에 들어갈 내용으로 맞는 것은? 4. 셰이크 오마르
<pre>
아라비아의 이스람교 승려인 _____가 커피를 마신 뒤 전파되었다는 설로서 _____가 아라비아 오우삽으로 추방된 산 속을 헤매다가 한 마리의 새가 빨간 열매를 쪼아 먹는 모습을 보고 그 열매를 따 먹었다는 설이다.
</pre>
- 윌리엄 유커스
- 칼디
- 아비세나
...
## 다음은 커피를 품종 개량하는 이유이다. 틀린 것은? 1. 생두 사이즈를 가능한 작게 하기 위해
- 생두 사이즈를 가능한 작게 하기 위해
- 병충해애 강한 품종을 위해
- 가뭄과 서리에 강한 품종을 위해
- 수확량을 늘리기 위해
...
## 커피의 어떤 것의 '첨가 유무'에 따라 분류되는 명칭이 아닌 것은? 3. 스트레이트 커피
- 레귤러 커피
- 디카페인 커피
- 스트레이트 커피
- 향 커피
...
## 로스팅 과정에서 발생되는 열의 성질에 속하지 않는 것은? 4. 열의 액화
- 열의 전도
- 대류
- 냉각
- 열의 액화
...
## 체(일정 크기의 구멍이 있음)의 통과 여부로 생두의 크기를 분류하는 방법은? 1. 스크린 사이즈
- 스크린 사이즈
- 사이즈 메시
- 오버 사이즈
- 빈 스케일
...
## 서울의 한 호텔에서 자리 잡은 우리나라 최초의 커피숍으로 맞는 것은? 2. 정동구락부
- 더 킹스 암스
- 정동구락부
- 거트리지 커피하우스
- 에닌젤
...
## 다음 설명에 적합한 커피에 관한 기원설로 맞는 것은? 2. 칼디의 전설
<pre>어느 날 양치기 소년은 염소들이 빨간 열매를 먹고 흥분하여 날 뛰는 모습을 보고 자신도 그 열매를 먹어보니 기분이 상쾌해짐을 느낄 수 있었다.</pre>
...
## 바닥면에 구멍이 촘촘하고 분쇄 원두를 담는 아래 그림 같은 포터필터의 구성 부분은? 2. 필터 바스켓
<img src="./img/filterBasket.jpg" width="150px"></img>
...
## 다음 중 커피 머신의 전원이 "OFF"된 원인과 가장 거리가 먼것은? 4. 수돗물 단수
- 플러그 및 콘센트 이상
- 메인 배전반 차단기 이상
- 전원 스위치 불량 
- 수돗물 단수
...
## 하나의 보일러로 온수, 스팀, 추출수 모두를 가열하는 방식은? 3. 일체형 보일러
- 분리형 보일러
- 독립형 보일러
- 일체형 보일러
- 혼합형 보일러
...
## 아래 그림과 같이 물의 양을 측정하는 커피 머신의 부품 명칭은? 3. 플로 메터
<img src="./img/flowMeter.jpg" alt="150px"></img>
...
## 다음 중 전자동 커피머신의 장점으로 틀린 것은? 1. 추출하는 사람에 따라 맛의 차이가 있다.
- 추출하는 사람에 따라 맛의 차이가 있다.
- 설치 공간이 넓을 필요 없다.
- 추출하기가 쉽고 편리하다.
- 디자인이 환경과 어울리고 다양하다.


## 다음 중 그라인더 날(Burr)의 종류로만 묶인 것은? 3. a-d
<pre>
a. 플랫 버
b. 플래시 버
c. 드릴 버
...
# 커피추출원론
## 다음은 크레마에 대한 설명이다. 틀린 것은? 4. 분쇄도 등의 조건이 변해도 크레마 품질은 일정하다.
- 단열층 역활을 하여 커피가 식는 것을 막는 효과가 있다.
- 커피 향이 함유된 지방 성분이 많다.
- 일반적으로 황금색이나 갈색이다.
- 분쇄도 등의 조건이 변해도 크레마 품질은 일정하다.


## 커피 추출 방법 중 여과법에 해당하는 것은? 2. 핸드드립
- 모카포트
- 핸드드립
- 프렌치 프레스
- 에스프레소 머신
...
## 에스프레소 위에 우유거품을 2~3스푼 올려 만드는 메뉴는? 4. 에스프레로 마끼아또
- 카페오레
- 카페 프레도
- 사케라또
- 에스프레소 마끼아또
...
## 커피 머신으로 추출할 때 일반적인 과정으로 바른 것은? 1. 포타필터 분리 -> 그라인딩 -> 탬핑 -> 추출 -> 넉 박스에 버리기
- 포타필터 분리 -> 그라인딩 -> 탬핑 -> 추출 -> 넉 박스에 버리기
- 탬핑 -> 그라인딩 -> 포타필터 분리 -> 추출 -> 넉 박스에 버리기
- 포타필터 분리 -> 추출 -> 탬핑 -> 그라인딩 -> 넉 박스에 버리기
- 그라인딩 -> 추출 -> 탬핑 -> 포타필터 분리 -> 넉 박스에 버리기
...
## 라떼아트시 폼 밀크를 부을 때 중요한 포인트라고 보기 어려운 것은? 4. 압력
- 높이
- 유속
- 유량
- 압력
...
## 더치 커피라고 흔히 알려진 추출 방법으로 맞는 것은? 2. 워터드립
- 사이폰
- 워터드립
- 이브릭
- 클레버
...
## 다음 중 식자재 구매계획 수립 시 고려사항이 아닌 것은? 2. 품목 매입
- 출하 시기
- 품목 매입
- 적정 가격
- 유통 기구
...
## 다음은 고객에 대한 인사 예절이다. 틀린 것은? 4. 앉아서 근무하는 경우 일어서서 인사할 필요없다.
- 고객과 마주 칠 때 인사한다.
- 적절한 인사말과 함께 한다.
- 허리를 적당히 굽혀 인사한다.
- 앉아서 근무하는 경우 일어서서 인사할 필요없다.
...
## 식자개 관리의 궁극적 목적으로 다음 중 옳은 것은? 1. 원가 절감
- 원가 절감
- 식자재 품질 향상
- 식자재 수량 파악
- 식자재 가격 설정
...
## 고객의 불평 처리에 관한 내용이다. 틀린 것은? 2. 서비스만 완벽하면 불평이 생길 수 없다.
- 항상 긍정적 자세로 불평 원인을 파악해야 한다.
- 서비스만 완벽하면 불평이 생길 수 없다.
- 동일한 불평이 반복되지 않도록 조치해야 한다.
- 만족할 만한 불평처리는 매장의 신뢰감을 높일 수 있다.


## 다음 중 고객을 대하는 커피바리스타의 마음가짐으로 틀린 것은? 2. 고객의 이름을 기억하지 않는다.
- 항상 미소 띤 얼굴을 한다.
- 고객의 이름을 기억하지 않는다.
- 신속하고 정확한 서비스를 한다.
- 긍정적이고 적극적인 사고로 임한다.
...
## 다음 중 카페인이 인체에 미치는 영향으로 틀린 것은? 3. 불면증을 유발하는 경우는 없다.
- 각성 효과가 있다.
...
## 다음 중 생두 가공 방식에 속하지 않는 것은? 2. 스프리트 법
- 건식법
- 스프리트 법
- 습식법
- 반건식법
...
## 우리가 사용하는 SCAA 로스팅 분류에서 "SCAA"가 뜻하는 단계는? 3. 미국스페셜티 커피연합회
- 유럽스페셜티 커피연합회
- 일본스페셜티 커피연합회
- 미국스페셜티 커피연합회
- 국제 커피테이스팅협회
...
## 다음 중 총독 부인과 스페인 연대장의 로맨틱한 상황에서 커피가 전파되었다는 나라는? 4. 브라질
- 독일
- 이탈리아
- 프랑스
- 브라질
...
## 우유 스티밍시 지방구와 기포층에 대한 설명으로 가장 알맞은 것은? 4. 기포층이 있고 지방구의 크기가 균일할 때 스팀을 잘한 것이다.
...
## 고지대에서 재배된 생두의 특성에 대한 설며이다. 틀린 것은? 3. 고지대 일수록 신맛이 좋지 않다.
- 고지대 일수록 단단하다.
- 고지대 일수록 밀도가 높다.
- 고지대 일수록 신맛이 좋지 않다.
- 고지대 일수록 향과 플레이버가 풍부하다.
...
## 식품이 조리나 가공 과정에서 갈색으로 변하는 것을 일컫는 말은? 2. 갈변 반응
- 색소 반응
- 갈변 반응
- 침출 반응
- 삼투압 반응
...
## 아래에서 설명하는 아라비카 품종으로 맞는 것은? 3. 티피카
<pre>
- 아라비카 원종에 가장 가까운 품종으로 알려져 있다.
- 생두는 긴 편이고 녹병에 취약하다.
- 블루마운틴, 하와이 코나가 대표적인 품종이다.
...
## 다음 중 보일러 내부 물의 양을 확인할 수 있는 부품의 명칭은? 4. 수위 게이지
- 압력 게이지
- 크렉 게이지
- 틈새 게이지
- 수위 게이지
...
## 그라인더가 '웅---' 하는 소리만 나고 작동하지 않을 때 조치로 맞는 것은? 2. 날의 간격이 너무 좁지 않은지 확인한다.
- 전원이 꺼져 있는지 확인한다.
...
## 아래 그림과 같은 부품의 명칭으로 맞는 것은? 3. 포타필터
<img src="./img/porterFilter.jpg" width="150px"></img>
...
## 다음 중 일반적으로 많이 사용되는 그라인더 분쇄 날의 크기에 속하는 것은? 4. 64mm
- 105mm
- 95mm
- 80mm
- 64mm
...
## 그라인더의 도저에 담긴 분쇄 원두가 아래로 떨어지도록 조정하는 부품으로 맞는 것은? 1. 도저 레버
- 도저 레버
- 서포트 포크
- 레큘레이터 노브
- 호퍼 게이트
...
## 커피 추출시 포타필터 주변으로 물이 흐를 때 조치로 맞는 것은? 3. 개스킷의 상태를 확인한다.
- 보일러에 물이 없는지 확인한다.
- 추출수 온도를 확인한다.
- 개스킷의 상태를 확인한다.
- 원두 분쇄 굵기를 확인한다.
...
## 워터드립 추출 방식은 어떤 힘의 작동을 이용한 것인가? 2. 중력
- 원심력
- 중력
- 항력
- 양력
...
## (사)한국커피바리스타협회의 커피바리스타 2급 실기에서 요구하는 에스프레소의 추출량의 범위는? 2. 20 ~ 30ml
- 10 ~ 20ml
- 20 ~ 30ml
- 30 ~ 40ml
- 40 ~ 50ml
...
## (사)한국바리스타협회의 커피바리스타 2급 실기에서 요구하는 에스프레소 추출 기준 시간은? 1. 20초 ~ 30초
- 20초 ~ 30초
- 30초 ~ 40초
- 40초 ~ 50초
- 50초 ~ 60초
...
## 이탈리아어로 '길다'라는 뜻으로 에스프레소를 시간상 길게 추출한 커피를 가리키는 것은? 2. 룽고
- 도피오
- 룽고
- 리스트레또
- 마끼아또
...
## 입안에서 느껴지는 커피의 질감, 무게감 등을 흔히 일컫는 말로 맞는 것은? 1. Body
- Body
- Overall
- Winey
- Ashy
...
## 다음은 블렌딩 할 때의 설명이다. 틀린 것은? 2. 되도록 많은 수의 원두를 배합하는 것이 좋다.
- 맛과 향은 체크하면서 배합 비율을 조정한다.
- 되도록 많은 수의 원두를 배합하는 것이 좋다.
- 유사한 맛과 향의 원두는 가급적 배합하지 않는다.
- 생두의 크기, 밀도, 함수율 등을 확인해야 한다.


## 다음 중 아래 박스 안에 있는 기구들을 사용하여 추출하는 방법으로 맞는 것은? 3. 핸드드립
<pre>
포트, 드립퍼, 페이퍼 필터, 융 필터
</pre>
- 더치 커피
...
# 매장관리서비스
## 다음 고객과의 대화 기법 중 틀린 것은? 4. 견해차이가 있으면 대화를 피한다.
- 이야기를 끝까지 들어준다.
- 가급적 맞장구를 쳐준다.
- 중요한 사안은 메모한다.
- 견해차이가 있으면 대화를 피한다.
...
## 주방의 안전 사고에 관한 설명이다. 틀린 것은? 4. 주방 담당자와 자주 접축한다.
- 바닥의 물기를 제거한다.
- 음식물 찌꺼기는 정해진 곳에 버린다.
- 기구나 뜨거운 물을 조심한다.
- 주방 담당자와 자주 접축한다.
...
## 빌 서비스 계산 서비스에 관한 내용이다. 틀린 것은? 3. 고객이 수표로 지불할 경우 수령을 거부한다.
- 계산서는 빌 홀더 끼워서 제공한다.
- 업무 시작 전 잔돈을 충분히 준비해 둔다.
- 고객이 수표로 지불할 경우 수령을 거부한다.
- 신용카드 계산 시 거래중지 카드인지 확인한다.
...
## 다음은 고객이 필기구를 찾을 때의 행동으로 바르지 않은 것은? 3. 펜(심 쪽) 끝을 고객 쪽으로 향하게 건넨다.
- 15도 각도로 건네는 것이 좋다.
- 두 손으로 받쳐서 건넨다.
- 펜(심 쪽) 끝을 고객 쪽으로 향하게 건넨다.
- 필기구는 항상 충분히 준비해 둔다.
...
- 밀봉하여 보관하는 것이 좋다.
- 직사광선을 피하는 것이 좋다.
- 적절한 보관 용기를 사용하는 것이 좋다.


## 다음 중 커피를 산패 시키는 원인이 아닌 것은? 4. 고도
- 산소
- 온도
- 습도
- 고도
...
## 다음은 커피나무에 관한 설명이다. 틀린 것은? 1. 열매 수확량을 늘리기 위해 크기를 높게 자라게 한다.
- 열매 수확량을 늘리기 위해 크기를 높게 자라게 한다.
...
## 유지를 보존하면서 공기 등의 작용으로 열화하여 불쾌한 맛과 냄새가 나는 현상은? 3. 산패도
- 신선도
- 선명도
- 산패도
- 오염도
...
## 커피열매 속에 씨가 둥글고 하나밖에 들어있지 않는 것을 칭하는 말은? 4. 피베리
- 실버스킨
- 센터 컷
- 뉴 크롭
- 피베리
...
## 우리나라에 1회용 인스턴트 커피가 등장한 시기로 맞는 것은? 3. 6 25 전쟁 시 미군에 의해
- 아관파천 때 러시아 공사에 의해
- 네덜란드에서 돌아온 헤이크 특사에 의해
- 6 25 전쟁 시 미군에 의해
- 모스크바 3상 회의 때 유엔에 의해


## 커피의 맛과 그 원인 성분으로 틀린 것은? 2. 떫은맛 - 단백질
- 신맛 - 지방산
- 떫은맛 - 단백질
- 쓴맛 - 카페인
- 단맛 - 당질
...
# 커피기계학
## 경도성분(칼슘/마그네슘 등)을 제거하여 부드러운 물로 만들어주는 기구는? 1. 연수기
- 연수기
- 정수기
- 온수기
- 제빙기
...
## 전자석의 원리를 이용하여 온수의 흐름을 통제하는 부품으로 맞는 것은? 4. 온수 전자밸브
- 온수 워터 펌프
- 온수 게이지
- 스팀 완드
- 온수 전자 밸브
...
## 커피 추출기구 중 사이폰 방식의 또다른 이름으로 맞는 것은? 3. 버큠 포트
- 프레셔 포트
- 램프 포트
- 버큠 포트
- 피스톤 포트
...
## 커피 머신 부품 중 세제나 약품으로 청소할 필요가 전혀 없는 것은? 1. 펌프 헤드
- 펌프 헤드
- 그룹 헤드
- 포타필터
- 스팀 완드
...
## 커피 머신 부품 중 아래 그림의 동그라미 안에 있는 명칭으로 맞는 것은? 4. 스파웃
<img src="./img/spaoot.png" width="150px"></img>
...
## 다음 중 커피 머신의 작동 방식이 아닌 것은? 1. 반영구식
- 반영구식
- 수동식
- 반자동식
- 전자동식
...
## 다음 중 그라인더 날의 재질이 아닌 것은? 2. 플라스틱 재질
- 스틸 재질
- 플라스틱 재질
- 세라믹 재질
- 티타늄 재질
...
## 맛있는 커피를 추출하기 위한 조건으로 맞지 않는 것은? 4. 광물질이 풍부한 경수
- 조화롭게 볶아진 원두
- 커피바리스타의 추출 기술
- 볶음도에 적합한 추출기구
- 광물질이 풍부한 경수
...
## 핸드 드립 추출 시 뜸들이기(불림)을 하는 이유로 가장 틀린 것은? 2. 추출 온도 상승
- 탄산가스 배출
- 추출 온도 상승
- 향과 맛 성분의 원활한 추출
- 물의 접촉면적 확보
...
## 커피 향기의 강도 중 '향기가 전혀 없을 때'를 나타내는 용어는? 1. 플랫
- 플랫
- 리치
- 스파이시
- 카라멜
...
## 다음 중 에스프레소 성분이 과소 추출되는 경우가 아닌 것은? 2. 추출 시간이 너무 길다.
- 분쇄 입자가 너무 굵다.
- 추출 시간이 너무 길다.
- 물의 온도가 낮다.
- 커피가 적정량보다 적게 사용됐다.
...
## 라떼아트를 할 때 우유를 밀어 넣는 기분을 일컫는 말은? 4. 푸어링
- 랜더링
- 믹싱
- 페인팅
- 푸어링
...
## 매장에서 커피바리스타가 지켜야할 내용으로 틀린 것은? 1. 남는 커피는 데워서 온도를 유지하라.
- 남는 커피는 데워서 온도를 유지하라.
- 커피 잔은 예열하여 사용하라.
- 신선한 원두를 사용하라.
- 깨끗하고 좋은 물을 사용하라.
...
## 다음 중 핸드드립 커피의 특징이 아닌 것은? 3. 추출 시간이 신속하다.
- 부드럽고 깔금한 맛이 특징이다.
- 기구 가격이 비교적 저렴하다.
- 추출 시간이 신속하다.
- 추출 기술이 중요하다.
...
# 매장관리서비스
## 다음 중 커피바리스타가 고객에게 보이는 태도로서 올바르지 않는 것은? 1. 고객을 교육시켜 알리려는 태도가 중요하다.
- 고객을 교육시켜 알리려는 태도가 중요하다.
- 고객의 입장에서 생각해 본다.
- 고객과의 시선은 안정적으로 유지한다.
- 고객의 말을 경청한다.
...
## 다음 중 주방에 발생하는 사고 원인으로 보기 어려운 것은? 4. 식재료 보존 실패
- 작업자들의 피로감
- 시설 및 장비 관리 소홀
- 전기와 가스 사용 부주의
- 식재료 보존 실패
...
## 다음은 selling Up(판매 기술)에 관한 내용이다. 틀린 것은? 1. 메뉴 추천은 피상적으로 하는 것이 좋다.
- 메뉴 추천은 피상적으로 하는 것이 좋다.
- Saling Up의 목적은 매출 극대화이다.
- 메뉴 추천을 주저하지 말아야 한다.
- 'NO(아니요)'라는 단어를 두려워 말아야 한다.
...
## 매장의 화재 예방에 관한 내용이다. 맞지 않는 것은? 2. 소화기 있는 위치는 수시로 변경한다.
- 인화물질 방치 여부를 사전에 점검한다.
- 소화기 있는 위치는 수시로 변경한다.
- 소화기구 적재를 수시로 확인한다.
- 방화문이 있는 경우 작동 여부를 수시로 점검한다.
...
# 커피학개론
## 현재 커피의 원산지라고 가장 잘 알려져 있는 나라로 맞는 것은? 3. 에티오피아
- 터키
- 브라질
- 에티오피아
- 미국
...
## 커피가 생산되는 남위 23.5도에서 북위 23.5도 사이의 지역을 일컫는 말로 맞는 것은? 2. 커피 벨트
- 커피 라인
- 커피 벨트
- 커피 지대
- 그린 존
...
## 우유 스티밍시 지방구와 기포층에 대한 설명으로 가장 알맞은 것은? 1. 기포층이 있고 지방구의 크기가 균일할 때 스팀을 잘한 것이다.
- 기포층이 있고 지방구의 크기가 균일할 때 스팀을 잘한 것이다.
- 기포층이 없고 지방구의 크기가 균일할 때 스팀을 잘한 것이다.
- 기포층이 있고 지방구의 크기가 서로 다를 때 스틤을 잘한 것이다.
- 기포층이 없고 지방구의 크기가 서로 다를 때 스팀을 잘한 것이다.
...
## 사람의 손으로 커피를 수확하는 방법으로만 연결된 것은? 3. a-d
<pre>
a. 머천다이징
b. 핸드 메이드
c. 스트립핑
...
## 우리나라에 커피가 최초로 전해진 시기로 맞는 것은 3. 고종
- 헌종
- 철종
- 고종
- 순종
...
## 브라질 모부스타의 95% 이상을 차지한다고 알려진 품종은? 2. 코닐론
- 카투아이
- 코닐론
- 문도노보
- 마라고지페
...
# 커피기계학
## 다음은 에스프레소 추출 속도에 대한 설며이다. 틀린 것은? 1. 펌프 압력이 낮으면 추출이 빨라진다.
- 펌프 압력이 낮으면 추출이 빨라진다.
- 원두가 신선할수록 추출이 느려진다.
- 도징량이 적으면 추출이 빨라진다.
- 분쇄 굵기가 가늘면 추출이 느려진다.
...
##  다음 중 포타필터와 전혀 무관한 부품은? 1. 수위 게이지
- 수위 게이지
- 홀더 스프링
- 필터 바스켓
- 필터홀더
...
## 커피 머신 중 우유를 데울 때나 거품을 낼 때 사용하는 것으로서 구멍이 2~5개로 이루어진 것은? 3. 스팀 노즐
- 스파웃
- 스팀 밸브
- 스팀 노즐
- 포터필터
...
## 다음은 그라인더 호퍼에 관한 설명이다. 가장 틀린 것은? 1. 물기가 있는 상태에 사용해도 무방하다.
...
## 다음 중 샤워 홀더를 통과한 물을 미세한 망을 통해 분산시켜 주는 부품으로 맞는 것은? 3. 샤워 스크린
- 로터피 펌프
- 그룹헤드
- 샤워 스크린
- 스팀 밸브
...
## 다음 중 커피 머신의 그룹 헤드와 관련이 없는 것은? 3. 호퍼 게이트
- 샤워 홀더
- 샤워 스크린
- 호퍼 게이트
- 개스킷
...
## 다음은 그라인더에 관한 설명이다. 틀린 것은? 4. 그라이인더 분쇄도 조정까지를 바리스타가 습득할 필요는 없다.
- 에스프레소 결과물에 지대한 영향을 미친다.
- 에스프레소 품질에서 흔히 그라인더 비중을 간과하는 경우가 많다.
- 그라인더는 제조사마다 조금씩 운용의 차이가 있다.
- 그라이인더 분쇄도 조정까지를 바리스타가 습득할 필요는 없다.
...
## 여러가지 기구 및 기계를 이용하여 커피 성분을 뽑아내는 과정을 일컫는 말로 맞는 것은? 3. 추출
- 가공
- 혼합
- 추출
- 분쇄
...
## 다음 중 커피 등의 음료 표면에 여러 가지 무늬나 그림을 만들어 내는 기술로 맞는 것은? 1. 라떼 아트
- 라떼아트
- 페인팅
- 드로잉
- 밀크 디자인
...
## 고객의 분실물 신고 접수 시 기록하는 사항이 아닌 것은? 1. 분실자 성별
- 분실자 성별
- 분실 일시
- 분실 장소
- 보관 담당자
...
## 다음은 고객이 떠난 후 테이블 정리 정돈에 관한 사항이다. 가장 틀린 것은? 3. 고객이 자리에서 일어나자마자 정리를 시작한다.
- 정리는 위생적이고 신속하게 한다.
- 사용된 기물은 종류별로 세척 공간으로 운반한다.
- 고객이 자리에서 일어나자마자 정리를 시작한다.
- 정리할 때는 옆 테이블 고객에게 방해가 되지 않도록 한다.
...
## 식품 위생관리의 궁극적인 목적으로 맞는 것은? 3. 질병 예방
- 매출 증대
- 소비자 만족
- 질병 예방
- 상권 분석
...
## 다음 중 생두 가공방식에 속하지 않는 것은? 2. 스프리트 법
- 건식법
- 스프리트법
- 습식법
- 반건식법
...
## 아래 그림의 동그라미 안에 있는 부품을 통칭하는 것으로 옳은 것은? 2. 도저
<img src="./img/grinder.png" width="150px">
- 탬퍼
- 도저
- 호퍼
- 원두 투입레버
...
## 다음 중 커피 머신의 전원이"OFF"된 원인과 가장 거리가 먼 것은? 4. 수돗물 단수
- 플러그 및 콘센트 이상
- 메인 배전반 차단기 이상
- 전원 스위치 불량
- 수돗물 단수
...
## 커피 머신에서 커피가 추출되는 속도가 너무 빠를때 그 원인으로 보기 어려운 것은? 3. 수도 밸브가 잠겼을 때
- 분쇄 입자가 클때
- 원두 투입량이 적을때
- 수도 밸브가 잠겼을 때
- 펌프 압력이 너무 높을때
...
## 다음 중 일반적으로 9bar의 압력을 이용하여 커피를 추출하는 방식으로 옮은 것은? 2. 커피 머신에 의한 추출
- 핸드르립에 의한 추출
- 커피 머신에 의한 추출
- 모카포트에 의한 추출
- 사이폰에 의한 추출
...
## 커피가루에 9bar의 압으로 뜨거운 물을 가하여 짧은 시간 동안 추출한 고농축 커피를 무엇이라고 하는가? 2. 에스프레소
- 마끼아또
- 에스프레소
- 아메리카노
- 카푸치노
...
## 에스프레소 양이 30ml일 때 그보다 적은 15~20ml의 양으로 추출된 강하고 진한 고농축 커피로 맞는 것은? 3. 리스트레또
- 에스프레소 로마노
- 카메 모카
- 리스트레또
- 코레토
...
## 다음 중 스티밍 작업에 유리하며 지방 함량을 2% 이내로 줄인 우유로 맞는 것은? 3. 저지방 우유
- 살균 우유
- 멸균 우유
- 저지방 우유
- 탈지 우유
...
## 다음은 커피를 고객에게 제공하는 방법 중 바르지 않은 것은? 4. 티스푼과 손잡이는 고객 왼쪽으로 향해 서비스 한다.
- 커피는 트레이에 들어 운반한다.
- 고객이 남녀인 경우 여성부터 서비스한다.
- 연장자에게 먼저 서비스한다.
- 티스푼과 손잡이는 고객 왼쪽으로 향해 서비스 한다.
...
## 다음은 점포를 계약할 때 유의사항이다. 가장 틀린 것은? 4. 권리금은 건물 소유주에게 지급한다. 
- 등기부 등본을 체크해야 한다.
- 등기부에 등재된 소유주와 계약해야 한다.
- 확정일자를 반드시 받는다.
- 권리금은 건물 소유주에게 지급한다. 
...
## 사람의 손으로 커피를 수확하는 방법으로만 연결된 것은? 3. c-d
<pre>
a. 머천다이징
b. 핸드 메이드
c. 스트립핑
...
## 다음 중 건식법에 대한 설명이 아닌 것은? 4. 펄프를 제거 후 건조시킨다.
- 햇빛이 좋은 지역에서 주로 이용한다.
- 로부스타 생산국에서 주로 이용한다.
- 생산 단가가 상대적으로 저렴하다.
- 펄프를 제거 후 건조시킨다.
...
## 다음 중 로스팅 시 거치는 단계라고 보기 어려운 것은? 4. 액화
- 건조
- 1차 크랙
- 냉각
- 액화
...
## 커피가 우리 인체에 미치는 일반적인 영향이다. 틀린 것은? 1. 피로감 증가
- 피로감 증가
- 이뇨 작용
- 각성 효과
- 항상화 효과
...
# 커피기계학
## 동 재질로서 포타필터와 결합하는 아래 그림과 같은 부분의 명칭은? 2. 그룹 헤드
<img src="./img/groupHead.jpg" width="150px"></img>
...
## 반자동 커피 머신의 단점이다. 틀린 것은? 4. 디지털 방식이므로 잔고장률이 높다. 
- 추출하는 사람에 따라 맛의 차이가 날수 있다.
- 기계에 대한 일정 지식과 기술이 필요하다.
- 비교적 넓은 설치 공간이 필요하다.
- 디지털 방식이므로 잔고장률이 높다. 
...
## 아래 그림속 부품의 알맞은 명칭은? 2. 보일러 압력게이지
<img src="./img/pressGage.jpg" width="150px"></img>
...
## 수동 그라인더에는 존재하고 자동 그라인더에 없는 부품은? 3. 도저 레버
- 호퍼
- 호퍼 게이트
- 도저 레버
- 입자 조절 레버
...
# 커피추출원론
## 이탈리아의 스토브 톱이라 불리고 증기압 원리를 이용하는 추출 기구는? 2. 모카 포트
- 사이폰
- 모카포트
- 체즈베
- 핸드드립
...
## 다음중 좋은 에스프레소를 위한 조건에 해당하지 않는 것은? 4. 고운 거품의 스티밍 기술
- 커피와 물의 적정비율
- 추출시간에 따른 정확한 분쇄
- 추출기구의 선택과 적절한 조작
- 고운 거품의 스티밍 기술
...
## 다음 메뉴 중 우유가 들어가지 않는 것은? 2. 카페 콘판나
- 카푸치노
- 카페 콘판나
- 카페 라떼
- 라떼 마끼아또
...
## 식자재 관리의 최종 목적으로 다음 중 옳은 것은? 1. 원가 절감
- 원가 절감
- 식자재 품질 향상
- 식자재 수량 파악
- 식자재 가격 결정
...
## 다음은 매장 정리정돈의 효과에 관한 설명이다.. 틀린 것은? 4. 업무 능률이 현저히 떨어진다.
- 안전사고를 예방할 수 있다.
- 시간과 에너지를 절약할 수 있다.
- 작업공간이 쾌적해 진다.
- 업무 능률이 현저히 떨어진다.
...
## "Coffee"의 어원 중 에티오피아의 지역 이름과 연관되어 있는 것은? 2. 카파
- 카와
- 카파
- 카베
- 카페
...
## 커피를 과다하게 마실 경우 빠져나간다고 알려진 영양성분은? 2. 칼슘
- 나트륨
- 칼슘
- 지질
- 비타민B
...
## 다음 중 수확한지 1년 미만 정도의 생두를 흔히 일컫는 말은? 2. 뉴 크롭
- 패스트 크롭
- 뉴 크롭
- 올드 크롭
- 세미 패스트 크롭
...
## 커피의 신선도 유지에 대한 설명이다. 틀린 것은? 3. 분쇄된 커피는 맛과 향의 휘발속도가 현저히 느려진다.
- 공기와 접촉에 의해 큰 영향을 받는다.
- 로스팅 후 약 2주가 지나면 맛과 향이 많이 소멸된다.
- 분쇄된 커피는 맛과 향의 휘발속도가 현저히 느려진다.
- 로스팅 후 발생하는 이산화탄소가 공기를 차단하는 역활도 한다.
...
## 다음 중 보일러 내부 물의 양을 확인할 수 있는 부품의 명칭은? 2. 수위 게이지
- 압력 게이지
- 수위 게이지
- 틈새 게이지
- 크렉 게이지
...
## 커피 머신에서 떨어지는 물을 받아 배수관으로 흘러주는 받침대의 명칭은? 3. 드립 트레이
- 급수 어셈블리
- 에어핀
- 드립 트레이
- 바이메탈
...
## (사)한국능력교육개발원 커피바리스타 2급 실기 에서 '카페 아메리카노' 결과물의 기준 온도는? 3. 60 ~ 70
- 40 ~ 50
- 50 ~ 60
- 60 ~ 70
- 70 ~ 80
...
## 추출 시간이 가장 길고 가장 많은 양의 에스프레소 메뉴는 무엇인가? 2. 룽고
- 도피오
- 룽고
- 리스트레또
- 마끼아또
...
## 다음 중 주방에 발생하는 사고 원인으로 보기 어려운 것은? 1. 식재료 보존 실패
- 식재료 보존 실패
- 시설 및 장비 관리 소홀
- 전기와 가스 사용 부주의
- 작업자들의 피로감
...
## 커피 매장 직원관리에 대한 설명이다. 틀린 것은? 1. 직원 수를 가급적 늘린다.
- 직원 수를 가급적 늘린다.
- 가족경영 형태도 고려할 만하다.
- 인간적 유대관계를 형성한다.
- 일정 권한을 주고 임하게 한다.
...
## 다음 중 캐러멜 마키아또 등 커피 표면에 소스를 뿌려 시각적인 효과를 주는 방법을 무엇이라고 하는가?
- 휘핑
- 스티밍
- 라떼아트
- 마끼아또
...
## 커피의 성분 중 단백질에 해당되는 유리아미노산의 특징이 아닌 것은?
...
## 라떼아트 시 폼 밀크를 부을 때 중요한 포인트라고 보기 어려운 것은?
- 높이
- 유속
- 유량
- 압력
